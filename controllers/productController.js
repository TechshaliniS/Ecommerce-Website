...
export const getProductController = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).send({ success: false, message: "Error retrieving products", error });
  }
};
...
export const getSingleProductController = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).send({ success: false, message: "Error retrieving single product", error });
  }
};
...
export const productPhotoController = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).send({ success: false, message: "Error retrieving photo", error });
  }
};
...
export const productListController = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(400).send({ success: false, message: "Error retrieving paginated products", error });
  }
};
...
export const relatedProductController = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(400).send({ success: false, message: "Error retrieving related products", error });
  }
};
...
export const productCategoryController = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(400).send({ success: false, message: "Error retrieving products by category", error });
  }
};
...
export const brainTreePaymentController = async (req, res) => {
  try {
    ...
    gateway.transaction.sale({ amount: total, paymentMethodNonce: nonce, options: { submitForSettlement: true } }, (error, result) => {
      if (result) {
